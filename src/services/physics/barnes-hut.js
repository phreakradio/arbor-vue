...
export default class BarnesHutTree{
    ...
    constructor(topleft, bottomright, theta){
        ...
        this._branchCtr = 0;
        this._root = this._newBranch();
        this._root.origin = topleft;
        this._root.size = bottomright.subtract(topleft);
    }
    ...
    applyForces(particle, repulsion){
    ...
    _newBranch(){
        ...
        if (this._branches[this._branchCtr]){
            ...
            branch = {origin:null, size:null, nw:undefined, ne:undefined, sw:undefined, se:undefined, mass:0};
            this._branches[this._branchCtr] = branch;
        }
